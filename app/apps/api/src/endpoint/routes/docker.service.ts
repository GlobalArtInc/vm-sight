  ...
  async exec(endpoint: EndpointEntity, data: EndpointExecuteDto) {
    ...
    switch (func) {
      ...
      case 'checkConnection':
        return this.checkConnection(endpoint.connectionInfo);
      case 'containers':
        return this.containers(action, params);
      case 'images':
        return this.images(action, params);
      default:
        throw new NotFoundException(ErrorEnum.UNKNOWN_FUNCTION);
    }
  }
