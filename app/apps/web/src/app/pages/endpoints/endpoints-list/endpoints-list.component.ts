  ...
  ngOnInit(): void {
    this.datatableConfig = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.httpClient.get('protected/endpoint', { params: dataTablesParameters }).subscribe(resp => {
          callback(resp);
        });
      },
      columns: [
        ...
        {
          title: 'Actived', data: 'isActive', render: function (data, type, full) {
        ...
        {
          title: 'Connection Type', data: 'connectionType', render: function (data, type, full) {
            return data;
          }
        },
      ]
